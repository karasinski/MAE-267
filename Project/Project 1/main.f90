...
!      write (1,'(F10.5, 5X, F10.5, 5X, F10.5)'), Point%x, Point%y, Point%T
  ...
  do while (residual > 1. .and. step <= 25)
    residual = maxval(Temperature)
...
!        call update_temperature(Point)
        ...
        write (1,'(I5, 5X, F10.8, 5X, F10.8, 5X, F10.5)'), step, Point%x, Point%y, Point%T
      end do
    end do
